...
public class textviewadapter extends BaseAdapter {
    ...
    {      	
        ...
        {
	       	holder.solar.setTextColor(convertView.getResources().getColor(R.color.color_spiner));
	       	holder.lunar.setTextColor(convertView.getResources().getColor(R.color.color_spiner));
